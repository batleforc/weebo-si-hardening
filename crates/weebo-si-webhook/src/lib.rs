...
//! (`AdmissionReview` in, allow/deny out — see RFC 0004's *Design → Contract*, and RFC 0008 for
//! the `kubearmorpolicies` path it also serves), and
...
pub use policy_guard::{
    PolicyGuardState, VALIDATE_KUBEARMOR_POLICIES_PATH, VALIDATE_NETWORK_POLICIES_PATH,
    policy_guard_router,
};
